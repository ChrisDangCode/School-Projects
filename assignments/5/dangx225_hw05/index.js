...
function addPlaceFunction(req, res, reqBody) {
  ...
  // Hint: You can use querystring module for parsing form data
	...
	var additionalyinfourl = post.additionalinfourl
	var jsonobject = {};
	...
	jsonobject['additionalyinfourl'] = additionalyinfourl;
	...
	fs.readFile('places.json', function(err, content){
		...
		fs.writeFile('places.json', tobewritten);
		res.writeHead(302, {'Location': 'favourites.html'});
		res.end();
	});
